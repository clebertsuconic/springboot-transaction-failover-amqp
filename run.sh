export "MAVEN_OPTS=-Dorg.slf4j.simpleLogger.log.org.apache.activemq.artemis.jms.example=info -Dorg.slf4j.simpleLogger.log.org.apache.qpid.jms=info -Dorg.slf4j.simpleLogger.log.org.springframework.jms.connection=info"
